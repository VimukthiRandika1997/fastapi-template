...
async def validation_exception_handler(request: Request, exc):
    """
    The exception hanlder to intercept RequestValidationError and ValidationError making sure we'll have a consistent
    ...
    return JSONResponse(response, status_code=status.HTTP_422_UNPROCESSABLE_CONTENT)